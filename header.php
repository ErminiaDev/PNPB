...
<body>
    ...
    <header id="header">
        ...
        <div class="container">
            <a class="navbar-brand text-center" href="https://painnoir-painblanc.fr">
            ...
            <ul class="navbar-nav d-flex justify-content-around">
                ...
                <li class="nav-item px-md-3">
                <a href="engagements.php" class="nav-link">Engagements</a>
                </li>
                <li class="nav-item px-md-3">
                <a href="products.php" class="nav-link">Produits</a>
                </li>
                <li class="nav-item px-md-3">
                    <a href="pointsofsale.php" class="nav-link">Points de vente</a>
                </li>
                <li class="nav-item px-md-3">
