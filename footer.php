<footer class="footer py-5">
        ...
        <div class="text-center">
            ...
            <p class="footer__developer pt-3 m-0">site créé par&nbsp;&nbsp;<span class="footer__developer--name">Erminia Dev&nbsp;</span>&copy; <span class="footer__developer--year"></span></p>
        </div>
        </div>
    </footer>
